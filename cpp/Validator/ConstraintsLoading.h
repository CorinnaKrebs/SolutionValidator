...
public:
	...
	static bool checkStacking(Item& item, Tour& tour, unsigned int tourEndPos, const Stacking& stacking, Instance& instance, const bool msg);
	...
	static bool checkUnloadingSequence(Item& item, Tour& tour, unsigned int tourEndPos, const UnloadingSequence& uSequence, Instance& instance, const bool msg);
	static bool checkFragility(Item& item, Tour& tour, unsigned int tourEndPos, Instance& instance, const bool msg);
	...
	static double calcSupport(Item& item, Instance& instance);
	

	static void getRelevantItems(Item& item, Tour& tour, unsigned int tourEndPos, Instance& instance);
	static int  getScaleFactor(const unsigned vehicleH);
};
