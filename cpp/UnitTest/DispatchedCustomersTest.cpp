...
namespace RoutingConstraints {
	...
	public:
		TEST_METHOD(Customer1Twice) {
			...
			// Test
			Assert::AreEqual(false, ConstraintsRouting::checkDispatchedCustomers(solution, instance));
		}
		...
		TEST_METHOD(Feasible) {
			...
			// Test
			Assert::AreEqual(true, ConstraintsRouting::checkDispatchedCustomers(solution, instance));
		}
	};
}