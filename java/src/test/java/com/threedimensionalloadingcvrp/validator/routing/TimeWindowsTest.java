...
public class TimeWindowsTest {
    ...
    public void TWCalculation() {
        ...
        Assertions.assertTrue(checkTimeWindows(solution, instance));

        time = calculateTime(1, 0, time, instance);
        Assertions.assertTrue(time > 0);
        double expected = depot_ST + distance01 + time_Diff + cust_ST;
        Assertions.assertEquals(expected, time);

        time = calculateTime(2, 1, time, instance);
        Assertions.assertTrue(time > 0);
    ...
    public void ExceedingTW() {
        ...
        // Test
        Assertions.assertFalse(checkTimeWindows(solution, instance));
    }
}
